...
\textbf{Sampling.}
We sample $\sim$200k games across four time periods and six ELO brackets (Table~1), yielding $\sim$8,333 games per cell. Only games with engine evaluation annotations are selected. The four periods are chosen around AI milestones: Pre-AI (2015-16) establishes a baseline before any strong neural engine; Early Post-AI (2018-19) captures the period after AlphaZero demonstrated superhuman play in December 2017; NNUE Era (2021-22) follows Stockfish's adoption of neural-network evaluation in 2020; and Modern (2024-25) reflects current play in a landscape where engine analysis is ubiquitous.
